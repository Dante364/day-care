...
use App\Livewire\Parent\ViewChildren as ParentViewChildren;
use App\Livewire\Parent\TrackPayments as ParentTrackPayments;
...
Route::middleware('auth:parent')->group(function() {
    ...
    Route::get('/parent/view-children', ParentViewChildren::class)->name('parent.view-children');
    Route::get('/parent/track-payments', ParentTrackPayments::class)->name('parent.track-payments');
});
